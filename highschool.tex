...
% --- Due to space, the remaining Math chapters follow the same pattern ---
% You already have their full text; copy each course into a \chapter with:
% - course metadata block
% - Course Description
% - Course Goals / Units of Study / Exam Components
% - Grading Breakdown table

% Suggested chapter headers (match your PDF exactly):
